...
@section('content')
    ...
    <div class="container mt-5">
        <a href="{{ route('admin/patients/create') }}" class="btn btn-primary rounded-pill"><i
                class="fa fa-user-plus fa-md"></i> Add Patient</a>
        <a href="{{ route('admin/patients/trash') }}" class="btn btn-danger rounded-pill"><i class="fa fa-trash"
                                ...
                                @forelse ($patients as $index => $patient)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('admin/patients/edit', ['id' => $patient->id]) }}"
                                                class="btn btn-warning rounded-pill"><i class="fa fa-edit"
                                                    aria-hidden="true"></i> Edit</a>
                                            <a onclick="confirmDelete(this)"
                                                data-url="{{ route('admin/patients/delete', ['id' => $patient->id]) }}"
