...
<a href="{{ route('admin/online_consultations/restore') }}" class="btn btn-warning rounded-pill">Restore All</a>
<a href="{{ route('admin/online_consultations/destroy') }}" class="btn btn-danger rounded-pill">Delete All</a>
    <a href="{{ route('admin/online_consultations') }}" class="btn btn-secondary rounded-pill">Back</a>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{route('admin/online_consultations/restore', ['id'=>$consultation->id])}}" class="btn btn-warning rounded-pill">Restore</a>
                                    <a onclick="confirmDelete(this)" data-url="{{ route('admin/online_consultations/destroy', ['id'=>$consultation->id]) }}" class="btn btn-danger rounded-pill">Delete Permanently</a>
                                </td>
                            </tr>
                            @empty
