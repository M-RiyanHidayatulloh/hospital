        ...
        <div class="navbar-content scroll-div ">
            ...
            <div class="">
                <div class="main-menu-header">
                    <img class="img-radius" src="{{ asset('admin/dist/assets/images/user/avatar-2.jpg') }}" alt="User-Profile-Image">
            ...
            <ul class="nav pcoded-inner-navbar ">
                ...
                <li class="nav-item">
                    <a href="{{ route('admin/doctors') }}" class="nav-link "><span class="pcoded-micon"><i class="feather icon-activity"></i></span><span class="pcoded-mtext">Doctor</span></a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('admin/rooms') }}" class="nav-link "><span class="pcoded-micon"><i class="feather icon-box"></i></span><span class="pcoded-mtext">Room</span></a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('admin/patients') }}" class="nav-link "><span class="pcoded-micon"><i class="feather icon-user"></i></span><span class="pcoded-mtext">Patient</span></a>
                </li>
                <li class="nav-item pcoded-menu-caption">
                    <label>Other</label>
                </li>
                ...
                <li class="nav-item">
                    <a href="{{ route('admin/payments') }}" class="nav-link "><span class="pcoded-micon"><i class="feather icon-credit-card"></i></span><span class="pcoded-mtext">Payment</span></a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('admin/online_consultations') }}" class="nav-link "><span class="pcoded-micon"><i class="feather icon-message-square"></i></span><span class="pcoded-mtext">Online
                            Consultation</span></a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('admin/health_informations') }}" class="nav-link "><span class="pcoded-micon"><i class="feather icon-info"></i></span><span class="pcoded-mtext">Health
                            Information</span></a>
                </li>
                @else
                <li class="nav-item">
